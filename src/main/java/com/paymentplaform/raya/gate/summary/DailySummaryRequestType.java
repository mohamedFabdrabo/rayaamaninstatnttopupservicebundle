...
@XmlType(name = "DailySummaryRequestType", namespace = "http://raya.paymentplaform.com/gate/summary", propOrder = {
    "dailySummaryRequest"
})
public class DailySummaryRequestType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final DailySummaryRequestType that = ((DailySummaryRequestType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof DailySummaryRequestType) {
            final DailySummaryRequestType copy = ((DailySummaryRequestType) draftCopy);
            {
    ...
    public Object createNewInstance() {
        return new DailySummaryRequestType();
    }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof DailySummaryRequestType) {
            final DailySummaryRequestType target = this;
            final DailySummaryRequestType leftObject = ((DailySummaryRequestType) left);
            final DailySummaryRequestType rightObject = ((DailySummaryRequestType) right);
            {
