...
@XmlType(name = "InquiryBalanceRequestType", namespace = "http://raya.paymentplaform.com/gate/balance", propOrder = {
    "inquiryBalanceRequest"
})
public class InquiryBalanceRequestType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final InquiryBalanceRequestType that = ((InquiryBalanceRequestType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof InquiryBalanceRequestType) {
            final InquiryBalanceRequestType copy = ((InquiryBalanceRequestType) draftCopy);
            {
    ...
    public Object createNewInstance() {
        return new InquiryBalanceRequestType();
    }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof InquiryBalanceRequestType) {
            final InquiryBalanceRequestType target = this;
            final InquiryBalanceRequestType leftObject = ((InquiryBalanceRequestType) left);
            final InquiryBalanceRequestType rightObject = ((InquiryBalanceRequestType) right);
            {
