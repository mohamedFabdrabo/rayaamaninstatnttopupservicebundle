...
@XmlType(name = "RequestHeaderType", namespace = "http://raya.paymentplaform.com/gate/pagservice", propOrder = {
    "requestHeader"
})
public class RequestHeaderType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final RequestHeaderType that = ((RequestHeaderType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof RequestHeaderType) {
            final RequestHeaderType copy = ((RequestHeaderType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof RequestHeaderType) {
            final RequestHeaderType target = this;
            final RequestHeaderType leftObject = ((RequestHeaderType) left);
            final RequestHeaderType rightObject = ((RequestHeaderType) right);
            {
