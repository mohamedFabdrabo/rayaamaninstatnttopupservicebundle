 ...
 *         &lt;element name="ServiceSubCategories" type="{http://raya.paymentplaform.com/gate/pagservice}ServiceCategory" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="isMNO" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "ServiceCategory", namespace = "http://raya.paymentplaform.com/gate/pagservice", propOrder = {
    "id",
    "serviceCategoryAr",
    "serviceCategoryEn",
    "services",
...
public class ServiceCategory implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    @XmlAttribute(name = "isMNO")
    protected String isMNO;
    ...
    /**
     * Gets the value of the isMNO property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getIsMNO() {
        return isMNO;
    }

    /**
     * Sets the value of the isMNO property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setIsMNO(String value) {
        this.isMNO = value;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            String theIsMNO;
            theIsMNO = this.getIsMNO();
            strategy.appendField(locator, this, "isMNO", buffer, theIsMNO, (this.isMNO!= null));
        }
        return buffer;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            String lhsIsMNO;
            lhsIsMNO = this.getIsMNO();
            String rhsIsMNO;
            rhsIsMNO = that.getIsMNO();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "isMNO", lhsIsMNO), LocatorUtils.property(thatLocator, "isMNO", rhsIsMNO), lhsIsMNO, rhsIsMNO, (this.isMNO!= null), (that.isMNO!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            String theIsMNO;
            theIsMNO = this.getIsMNO();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "isMNO", theIsMNO), currentHashCode, theIsMNO, (this.isMNO!= null));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ServiceCategory) {
            ...
            {
                Boolean isMNOShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.isMNO!= null));
                if (isMNOShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceIsMNO;
                    sourceIsMNO = this.getIsMNO();
                    String copyIsMNO = ((String) strategy.copy(LocatorUtils.property(locator, "isMNO", sourceIsMNO), sourceIsMNO, (this.isMNO!= null)));
                    copy.setIsMNO(copyIsMNO);
                } else {
                    if (isMNOShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.isMNO = null;
                    }
                }
            }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ServiceCategory) {
            ...
            {
                Boolean isMNOShouldBeMergedAndSet = strategy.shouldBeMergedAndSet(leftLocator, rightLocator, (leftObject.isMNO!= null), (rightObject.isMNO!= null));
                if (isMNOShouldBeMergedAndSet == Boolean.TRUE) {
                    String lhsIsMNO;
                    lhsIsMNO = leftObject.getIsMNO();
                    String rhsIsMNO;
                    rhsIsMNO = rightObject.getIsMNO();
                    String mergedIsMNO = ((String) strategy.merge(LocatorUtils.property(leftLocator, "isMNO", lhsIsMNO), LocatorUtils.property(rightLocator, "isMNO", rhsIsMNO), lhsIsMNO, rhsIsMNO, (leftObject.isMNO!= null), (rightObject.isMNO!= null)));
                    target.setIsMNO(mergedIsMNO);
                } else {
                    if (isMNOShouldBeMergedAndSet == Boolean.FALSE) {
                        target.isMNO = null;
                    }
                }
            }
