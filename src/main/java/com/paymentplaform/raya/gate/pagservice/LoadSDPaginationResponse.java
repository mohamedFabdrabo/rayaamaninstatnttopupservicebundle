 ...
 *         &lt;element name="MessageBody" type="{http://raya.paymentplaform.com/gate/pagservice}LoadSDPaginationResponseType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "LoadSDPaginationResponse", namespace = "http://raya.paymentplaform.com/gate/pagservice")
public class LoadSDPaginationResponse implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    @XmlElement(name = "MessageHeader", required = true)
    protected ResponseHeaderType messageHeader;
    @XmlElement(name = "MessageBody", required = true)
    protected LoadSDPaginationResponseType messageBody;
     ...
     * @return
     *     possible object is
     *     {@link LoadSDPaginationResponseType }
     *     
     */
    public LoadSDPaginationResponseType getMessageBody() {
        return messageBody;
    }
     ...
     *     
     */
    public void setMessageBody(LoadSDPaginationResponseType value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            LoadSDPaginationResponseType theMessageBody;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LoadSDPaginationResponse that = ((LoadSDPaginationResponse) object);
        {
        ...
        {
            LoadSDPaginationResponseType lhsMessageBody;
            lhsMessageBody = this.getMessageBody();
            LoadSDPaginationResponseType rhsMessageBody;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LoadSDPaginationResponse) {
            final LoadSDPaginationResponse copy = ((LoadSDPaginationResponse) draftCopy);
            {
            ...
            }
            {
                ...
                if (messageBodyShouldBeCopiedAndSet == Boolean.TRUE) {
                    LoadSDPaginationResponseType sourceMessageBody;
                    sourceMessageBody = this.getMessageBody();
                    LoadSDPaginationResponseType copyMessageBody = ((LoadSDPaginationResponseType) strategy.copy(LocatorUtils.property(locator, "messageBody", sourceMessageBody), sourceMessageBody, (this.messageBody!= null)));
    ...
    public Object createNewInstance() {
        return new LoadSDPaginationResponse();
    }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof LoadSDPaginationResponse) {
            final LoadSDPaginationResponse target = this;
            final LoadSDPaginationResponse leftObject = ((LoadSDPaginationResponse) left);
            final LoadSDPaginationResponse rightObject = ((LoadSDPaginationResponse) right);
            {
            ...
            }
            {
                ...
                if (messageBodyShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    LoadSDPaginationResponseType mergedMessageBody = ((LoadSDPaginationResponseType) strategy.merge(LocatorUtils.property(leftLocator, "messageBody", lhsMessageBody), LocatorUtils.property(rightLocator, "messageBody", rhsMessageBody), lhsMessageBody, rhsMessageBody, (leftObject.messageBody!= null), (rightObject.messageBody!= null)));
