 ...
 *       &lt;sequence&gt;
 *         &lt;element name="MessageHeader" type="{http://raya.paymentplaform.com/gate/services/}RequestHeaderType"/&gt;
 *         &lt;element name="MessageBody" type="{http://raya.paymentplaform.com/gate/services/}LoadServiceDirectoryRequestType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "LoadServiceDirectoryReq", namespace = "http://raya.paymentplaform.com/gate/services/")
public class LoadServiceDirectoryReq implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{

    @XmlElement(name = "MessageHeader", required = true)
    protected RequestHeaderType messageHeader;
    @XmlElement(name = "MessageBody", required = true)
    protected LoadServiceDirectoryRequestType messageBody;
     ...
     * @return
     *     possible object is
     *     {@link LoadServiceDirectoryRequestType }
     *     
     */
    public LoadServiceDirectoryRequestType getMessageBody() {
        return messageBody;
    }
     ...
     *     
     */
    public void setMessageBody(LoadServiceDirectoryRequestType value) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            LoadServiceDirectoryRequestType theMessageBody;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LoadServiceDirectoryReq that = ((LoadServiceDirectoryReq) object);
        {
        ...
        {
            LoadServiceDirectoryRequestType lhsMessageBody;
            lhsMessageBody = this.getMessageBody();
            LoadServiceDirectoryRequestType rhsMessageBody;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LoadServiceDirectoryReq) {
            final LoadServiceDirectoryReq copy = ((LoadServiceDirectoryReq) draftCopy);
            {
            ...
            }
            {
                ...
                if (messageBodyShouldBeCopiedAndSet == Boolean.TRUE) {
                    LoadServiceDirectoryRequestType sourceMessageBody;
                    sourceMessageBody = this.getMessageBody();
                    LoadServiceDirectoryRequestType copyMessageBody = ((LoadServiceDirectoryRequestType) strategy.copy(LocatorUtils.property(locator, "messageBody", sourceMessageBody), sourceMessageBody, (this.messageBody!= null)));
    ...
    public Object createNewInstance() {
        return new LoadServiceDirectoryReq();
    }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof LoadServiceDirectoryReq) {
            final LoadServiceDirectoryReq target = this;
            final LoadServiceDirectoryReq leftObject = ((LoadServiceDirectoryReq) left);
            final LoadServiceDirectoryReq rightObject = ((LoadServiceDirectoryReq) right);
            {
            ...
            }
            {
                ...
                if (messageBodyShouldBeMergedAndSet == Boolean.TRUE) {
                    ...
                    LoadServiceDirectoryRequestType mergedMessageBody = ((LoadServiceDirectoryRequestType) strategy.merge(LocatorUtils.property(leftLocator, "messageBody", lhsMessageBody), LocatorUtils.property(rightLocator, "messageBody", rhsMessageBody), lhsMessageBody, rhsMessageBody, (leftObject.messageBody!= null), (rightObject.messageBody!= null)));
