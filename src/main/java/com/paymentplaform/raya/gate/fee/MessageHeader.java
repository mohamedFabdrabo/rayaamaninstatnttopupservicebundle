...
@XmlType(name = "RequestHeaderType", namespace = "http://raya.paymentplaform.com/gate/fee", propOrder = {
    "requestHeader"
})
@XmlRootElement(name = "MessageHeader", namespace = "http://raya.paymentplaform.com/gate/fee")
