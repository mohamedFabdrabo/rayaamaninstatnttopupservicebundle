...
@XmlType(name = "ChangeProfileRequestType", namespace = "http://raya.paymentplaform.com/gate/change", propOrder = {
    "changeProfileRequest"
})
public class ChangeProfileRequestType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ChangeProfileRequestType that = ((ChangeProfileRequestType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ChangeProfileRequestType) {
            final ChangeProfileRequestType copy = ((ChangeProfileRequestType) draftCopy);
            {
    ...
    public Object createNewInstance() {
        return new ChangeProfileRequestType();
    }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ChangeProfileRequestType) {
            final ChangeProfileRequestType target = this;
            final ChangeProfileRequestType leftObject = ((ChangeProfileRequestType) left);
            final ChangeProfileRequestType rightObject = ((ChangeProfileRequestType) right);
            {
