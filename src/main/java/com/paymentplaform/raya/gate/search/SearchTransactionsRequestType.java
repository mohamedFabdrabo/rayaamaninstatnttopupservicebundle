...
@XmlType(name = "SearchTransactionsRequestType", namespace = "http://raya.paymentplaform.com/gate/search", propOrder = {
    "searchTransactionsRequest"
})
public class SearchTransactionsRequestType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final SearchTransactionsRequestType that = ((SearchTransactionsRequestType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof SearchTransactionsRequestType) {
            final SearchTransactionsRequestType copy = ((SearchTransactionsRequestType) draftCopy);
            {
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof SearchTransactionsRequestType) {
            final SearchTransactionsRequestType target = this;
            final SearchTransactionsRequestType leftObject = ((SearchTransactionsRequestType) left);
            final SearchTransactionsRequestType rightObject = ((SearchTransactionsRequestType) right);
            {
