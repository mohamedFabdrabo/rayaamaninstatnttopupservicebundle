...
@XmlType(name = "BillsInquiryRequestType", namespace = "http://raya.paymentplaform.com/gate/inq", propOrder = {
    "billInquiryRequest"
})
public class BillsInquiryRequestType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final BillsInquiryRequestType that = ((BillsInquiryRequestType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof BillsInquiryRequestType) {
            final BillsInquiryRequestType copy = ((BillsInquiryRequestType) draftCopy);
            {
    ...
    public Object createNewInstance() {
        return new BillsInquiryRequestType();
    }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof BillsInquiryRequestType) {
            final BillsInquiryRequestType target = this;
            final BillsInquiryRequestType leftObject = ((BillsInquiryRequestType) left);
            final BillsInquiryRequestType rightObject = ((BillsInquiryRequestType) right);
            {
