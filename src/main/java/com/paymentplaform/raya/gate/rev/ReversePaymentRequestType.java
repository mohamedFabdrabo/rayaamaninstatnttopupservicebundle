...
@XmlType(name = "ReversePaymentRequestType", namespace = "http://raya.paymentplaform.com/gate/rev", propOrder = {
    "reversePaymentRequest"
})
public class ReversePaymentRequestType implements Cloneable, CopyTo2, Equals2, HashCode2, MergeFrom2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final ReversePaymentRequestType that = ((ReversePaymentRequestType) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof ReversePaymentRequestType) {
            final ReversePaymentRequestType copy = ((ReversePaymentRequestType) draftCopy);
            {
    ...
    public Object createNewInstance() {
        return new ReversePaymentRequestType();
    }
    ...
    public void mergeFrom(ObjectLocator leftLocator, ObjectLocator rightLocator, Object left, Object right, MergeStrategy2 strategy) {
        if (right instanceof ReversePaymentRequestType) {
            final ReversePaymentRequestType target = this;
            final ReversePaymentRequestType leftObject = ((ReversePaymentRequestType) left);
            final ReversePaymentRequestType rightObject = ((ReversePaymentRequestType) right);
            {
